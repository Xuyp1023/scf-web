...
public class ProductConfigController {
    ...
    public @ResponseBody String AddProductAssetDictRelation(HttpServletRequest request, String productCode,
            String listIdType) {
        // Map<String, Object> anMap = Servlets.getParametersStartingWith(request, "");
    ...
    public @ResponseBody String queryCoreByProduct(HttpServletRequest request, String productCode, int pageNum,
    ...
    public @ResponseBody String queryAssetDict(HttpServletRequest request, Long factorNo, int pageNum, int pageSize,
            int flag) {
        Map<String, Object> anMap = Servlets.getParametersStartingWith(request, "");
        logger.info("分页查询资产类型列表,入参：" + anMap.toString());
