...
public class CommissionFileDownController {
    ...
    /*
     * @Reference(interfaceClass = IContractCorpAccountService.class) private IContractCorpAccountService custFileDubboService;
     */
     ...
     * @param pageNum
     * @param pageSize
     * @return custNo GTEimportDate LTEimportDate
     */
    ...
    public @ResponseBody String queryFileList(HttpServletRequest request, String flag, int pageNum, int pageSize) {
        ...
        /*
         * @SuppressWarnings("unused") String webFindCorpInfo = custFileDubboService.webFindCorpInfo(123l);
         */
     ...
     * @param pageNum
     * @param pageSize
     *            custNo GTEimportDate LTEimportDate confirmStatus
     * @return
     */
