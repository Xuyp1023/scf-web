...
public class RepaymentController {
    ...
    public @ResponseBody String queryRepaymentFee(HttpServletRequest request, String requestNo, String payType,
            String factorNo, String payDate, BigDecimal totalBalance) {
        Map<String, Object> map = Servlets.getParametersStartingWith(request, "");
    ...
    public @ResponseBody String querySellerRepaymentFee(HttpServletRequest request, String requestNo, String payType,
            String payDate, BigDecimal totalBalance) {
        Map<String, Object> map = Servlets.getParametersStartingWith(request, "");
    ...
    public @ResponseBody String queryDistributeFee(HttpServletRequest request, String requestNo, String payType,
            String payDate, BigDecimal totalBalance) {
        Map<String, Object> map = Servlets.getParametersStartingWith(request, "");
    ...
    public @ResponseBody String calculatEndDate(HttpServletRequest request, String startDate, Integer period,
            Integer periodUnit) {
        return ControllerExceptionHandler.exec(new ExceptionHandler() {
            @Override
            public String handle() {
    ...
    public @ResponseBody String calculatFee(HttpServletRequest request, BigDecimal ratio, BigDecimal managementRatio,
            BigDecimal extensionBalance) {
        return ControllerExceptionHandler.exec(new ExceptionHandler() {
            @Override
            public String handle() {
    ...
    public @ResponseBody String payAssigned(HttpServletRequest request, String requestNo, String startDate,
    ...
    public @ResponseBody String extensionList(HttpServletRequest request, String requestNo, int flag, int pageNum,
            int pageSize) {
        Map<String, Object> map = Servlets.getParametersStartingWith(request, "");
